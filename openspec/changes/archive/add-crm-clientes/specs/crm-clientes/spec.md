...
> Capability nova — este delta contém apenas `ADDED Requirements` e, na conclusão da
> change, vira a spec inicial de `crm-clientes` em `openspec/specs/crm-clientes/spec.md`.
