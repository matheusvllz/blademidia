# Delta for whatsapp-canal

> Capability nova — nasce nesta change. Este delta contém apenas `ADDED Requirements` e, na
> conclusão, vira `openspec/specs/whatsapp-canal/spec.md`.
