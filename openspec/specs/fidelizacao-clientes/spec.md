# Capability: fidelizacao-clientes

> Spec permanente — fonte da verdade do comportamento de fidelização do produto.
> Não editar diretamente: toda mudança passa por uma change (ver [workflow](../../workflow.md)).
>
> Histórico:
> - Fase 4 (núcleo — contagem, sinalização, resgate) estabelecida pela change
>   `add-fidelizacao-e-funcionarios` (concluída 2026-07-16).
>
